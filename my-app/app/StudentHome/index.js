...
const StudentHome = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get("http://192.168.100.18:8081/session", {
    ...
    useEffect(() => {
        const fetchStudentData = async () => {
            try {
                const response = await axios.get(`http://192.168.100.18:8081/result/GetIndividualStudentResult/${userId}`, {
                    withCredentials: true,
                });
