...
function StudentViewProforma() {
  ...
  const getCgpaMessage = (cgpa) => {
    if (cgpa < 3.00) {
      return (
        <div>
          Your current CGPA is <strong>{cgpa}</strong>. It's important to reflect on your performance and identify areas for improvement. With dedication and effort, you can turn things around. Stay motivated and keep striving for better results!
        </div>
      );
    } else if (cgpa <= 3.50) {
      return (
        <div>
          Your current CGPA is <strong>{cgpa}</strong>. You're doing well, and your dedication is evident. You're making steady progress, and with a bit more effort, you'll reach even greater heights. Keep up the good work!
        </div>
      );
    } else {
      return (
        <div>
          Your current CGPA is <strong>{cgpa}</strong>. You're on a great path, and your hard work is showing. Keep up the excellent effort and maintain your focus. Keep it up!
        </div>
      );
    }
  };
  ...
  return (
    <div id="StudentViewProformaMainDiv">
      ...
      <div id="StudentViewProformaTopBar">
        ...
        {showPopup && (
          <div id="StudentViewProformaPopup">
            <div id="StudentViewProformaPopupContent">
