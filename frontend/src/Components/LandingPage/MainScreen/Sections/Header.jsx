...
// Assets
import HeaderImage from "./im.jpeg";
...
export default function Header() {
  return (
    <Wrapper id="home" className="container flexSpaceCenter">
      ...
      <RightSide>
        <ImageWrapper>
          <Img className="radius8" src={HeaderImage} alt="office" style={{ zIndex: 9, width: "426px", height: "440px" ,marginTop:"-150px"}} />
        ...
        <GreyDiv className="lightBg" style={{height:"80vh"}}></GreyDiv>
      </RightSide>
    </Wrapper>
  );
}
