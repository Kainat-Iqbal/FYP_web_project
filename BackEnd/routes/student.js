...
const { addStudent, viewStudent, viewStudentPieChart, viewAllIndividualStudentDetails, viewStudentDetailsAccordingToSemester,getStudentNotifications } = require("../controller/student");
...
studentRouter.route('/Get/Notification/:id').get(getStudentNotifications)
